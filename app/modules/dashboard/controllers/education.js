        ...
        datasets: [
            {
                ...
                data: [3.50,3.71,3.67,3.73]
            }
        ]
    };

    vm.mscData = {
        labels: ["Sem 1 ", "Sem 2-1", "Sem 2-2","Sem 3-1","Sem 3-2","Sem 4-1","Sem 4-2"],
        datasets: [
            {
                ...
                pointHighlightFill: "#fff",
                pointHighlightStroke: "rgba(220,220,220,1)",
                data: [70.00, 72.4, 67.30, 74.8,69.73,76.5,87.14]
            }
        ]
    };

    vm.hscData = {
        labels: ["Sanskrit", "English", "Maths-A","Maths-B" ,"Physics", "Chemistry", "pratical Physics", " pratical Chemistry"],
        datasets: [
            {
                label: "My HSC Marks",
                ...
                pointHighlightFill: "#fff",
                pointHighlightStroke: "rgba(220,220,220,1)",
                data: [96.5,89.3,76.0,87.5,79.16,100,83.3]
            }
        ]
    };
